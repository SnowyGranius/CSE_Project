...
permeability_values_circle = []
porosity_values_circle = []
surface_values_circle = []
euler_total_values_circle = []
for df in data_csv_circle:
    permeability_values_circle.extend(df['Permeability'])
    porosity_values_circle.extend(df['Porosity'])
    surface_values_circle.extend(df['Surface'])
    euler_total_values_circle.extend(df['Euler_total'])
...
permeability_values_circle = np.array(permeability_values_circle)
porosity_values_circle = np.array(porosity_values_circle)
surface_values_circle = np.array(surface_values_circle)
euler_total_values_circle = np.array(euler_total_values_circle)
...
minkowski_values_circle = np.column_stack((porosity_values_circle, surface_values_circle, euler_total_values_circle))
permeability_minkowski_circle = np.column_stack((permeability_values_circle, minkowski_values_circle))
...
for image_file in all_images:
    ...
    if match:
        ...
        if model_number == 1:
            continue
        if shape == 'circle':
            data_images_circle.append({'Image': image})
        else:
            data_images.append({'Image': image})

print(f'Number of circle images: {len(data_images_circle)}')
...
data_images_circle = [np.array(image['Image'], dtype=np.float64) for image in data_images_circle]
...
train_permeability_minkowski = permeability_minkowski_circle
