...
#MLP arhitecture, find optimum number of hidden neurons and hidden layers
class MLP(nn.Module):
    '''
...
pathlist = ['Heterogenous_samples', 'Porespy_homogenous_diamater','Threshold_homogenous_diamater_small_RCP', 'Threshold_homogenous_diamater_wide_RCP' ]
