...
for cnn in [NoPoolCNN1().to(my_device), NoPoolCNN2().to(my_device), NoPoolCNN3().to(my_device), NoPoolCNN4().to(my_device), NoPoolCNN5().to(my_device)]:
