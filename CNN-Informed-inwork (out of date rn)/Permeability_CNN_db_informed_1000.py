...
scaler_permeability = MaxAbsScaler()
...
train_permeability_minkowski = np.log(train_permeability_minkowski[:, 0])
...
test_permeability_minkowski = np.log(test_permeability_minkowski[:, 0])
...
if validation:
    val_permeability_minkowski = np.log(val_permeability_minkowski[:, 0])
