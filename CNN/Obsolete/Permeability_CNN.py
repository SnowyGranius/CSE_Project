...
print(f'Length of training dataset: {len(train_permeability)}')
batch_size = 37
...
print(f'Showing {BasicCNN.__name__}')
summary(BasicCNN().to('cuda'), input_size=(1, 1000, 1000))
# print(f'Showing {NoPoolCNN1.__name__}')
# summary(NoPoolCNN1().to('cuda'), input_size=(1, 1000, 1000))
# print(f'Showing {NoPoolCNN2.__name__}')
# summary(NoPoolCNN2().to('cuda'), input_size=(1, 1000, 1000))
# print(f'Showing {NoPoolCNN3.__name__}')
# summary(NoPoolCNN3().to('cuda'), input_size=(1, 1000, 1000))
# print(f'Showing {NoPoolCNN4.__name__}')
...
for cnn in [BasicCNN().to(my_device), MLPCNN().to(my_device), NoPoolCNN1().to(my_device), NoPoolCNN2().to(my_device), NoPoolCNN3().to(my_device), NoPoolCNN4().to(my_device), NoPoolCNN5().to(my_device)]:
    start_time = time.time()
    for lr in [5e-4, 1e-4, 5e-4, 1e-3]:
