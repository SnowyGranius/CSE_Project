...
train_permeability = np.log(train_permeability_minkowski[:, 0])
...
test_permeability = np.log(test_permeability_minkowski[:, 0])
...
if validation:
    val_permeability = np.log(val_permeability_minkowski[:, 0])
